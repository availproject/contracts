    ...
    IAvailBridge
{
    ...
    /**
     * @notice  Update the value of reset counter
     * @param   newResetCounter  New value of reset counter
     */
    function updateResetCounter(uint8 newResetCounter) external onlyRole(DEFAULT_ADMIN_ROLE) {
